      ...
      <div className="form-grid">
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="civilEngineering">Civil & Structural Engineering</SelectItem>
              <SelectItem value="projectManagement">Project Management</SelectItem>
              <SelectItem value="waterInfrastructure">Water Infrastructure</SelectItem>
              <SelectItem value="smmeDevelopment">SMME Development & Training</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div>
          <Label htmlFor="projectDescription">Brief Description of Project/Requirements</Label>
          <Textarea
